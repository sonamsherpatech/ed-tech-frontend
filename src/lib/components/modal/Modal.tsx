...
import { ICategoryAddData } from "@/lib/store/institute/category/institute-category-slice-tyeps";
...
const Modal: React.FC<IHandleCloseModal> = ({ handleCloseModal }) => {
  ...
  const handleCategoryDataSubmission = async (
          ...
          <form onSubmit={handleCategoryDataSubmission}>
            ...
            <div>
              ...
              <textarea
                ...
                id="website_url"
                className="w-full mt-1 p-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 placeholder-gray-400 dark:placeholder-gray-500"
                placeholder="web_delvelop ment realated descriptoin"
                required
              />
            </div>
