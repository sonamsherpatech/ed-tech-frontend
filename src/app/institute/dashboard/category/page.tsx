...
import { IInstituteCategoryIntitalDataCategory } from "@/lib/store/institute/category/institute-category-slice-tyeps";
      ...
      <div className=" overflow-x-auto">
        ...
        <div className="min-w-full inline-block align-middle">
          <div className="flex justify-between items-start">
            ...
            <button
              onClick={openModal}
              className="inline-block px-7 py-2.5 overflow-hidden text-sm font-semibold transition-transform rounded-full group text text-green-700/70 bg-green-300/30 hover:bg-green-500/70 hover:text-white cursor-pointer "
            >
              +Create Category
            </button>
          </div>
